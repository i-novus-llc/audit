...
public class ExtendedSsoEventsServiceTest {
     ...
     * соответственно 90 раз должен отработать метод asyncAuditClient.add для добавления события в аудит
     */
    @Test
    ...
    /*
     * Проверяем количество вызовов сервиса событий
     * При условии отсутсвия событий, сервис должен вызваться 1 раз
